...
CREATE TABLE public."Orders" (
    ...
    CONSTRAINT "FK_Orders_Products_ProductId" FOREIGN KEY ("ProductId") REFERENCES public."Products"("Id"),
...
INSERT INTO public."Users" ("Name","OAuth","Email","Role","Active") VALUES
    ...
    ('Derp2','jhkjhljhkwejifuhiwine','Derpipose2@gmail.com','Customer',true);
...
INSERT INTO public."OrderProduct" ("OrderId","ProductId") VALUES
    (1,1),
    (2,2);
