        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    OAuth = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Portfolios_ProductTypes_ProductTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomRequests_ProductTypes_ProductTypeId",
                        column: x => x.ProductTypeId,
                        principalTable: "ProductTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PortfolioImage", x => new { x.ImageId, x.PortfolioId });
                    table.ForeignKey(
                        name: "FK_PortfolioImage_Images_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomRequests_ProductTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Portfolios_ProductTypeId",
                table: "Portfolios",
                column: "ProductTypeId");
